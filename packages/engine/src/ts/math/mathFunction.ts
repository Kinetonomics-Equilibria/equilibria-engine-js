...
import { ViewObjectDefinition } from "../view/viewObjects/viewObject";
import { replaceVariable } from "../KGAuthor/parsers/parsingFunctions";
    ...
    updateFunctionString(str: string, scope: { params: {}, calcs: {}, colors: {} }) {
        ...
        if (references) {
            references.forEach(function (name) {
                str = replaceVariable(str, name, getCalc(scope, name));
            });
        }
